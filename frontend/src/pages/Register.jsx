...
export default function Register() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#020204]">
        <div className="text-center">
          ...
          <p className="text-[#a78bfa]">Creating your warrior...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#020204]" data-testid="register-page">
      ...
      <Card className="w-full max-w-sm bg-[#0a0a10]/95 border-[#1a1a28] backdrop-blur-xl relative z-10">
        <CardHeader className="text-center space-y-4 pb-2">
          ...
          <div>
            <CardTitle className="text-2xl font-display font-bold text-white">Create Warrior</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <Label htmlFor="username" className="text-[#a8a8b8] text-sm">Warrior Name</Label>
              <Input
                id="username"
                type="text"
          ...
          <p className="text-center text-[#68687a] text-sm">
            Already a warrior?{" "}
            <Link to="/login" className="text-[#a78bfa] hover:text-[#c4b5fd] transition-colors" data-testid="login-link">
              Return to arena
            </Link>
          </p>
        </CardContent>
